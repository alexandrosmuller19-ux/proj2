...
class Game:
    def __init__(self):
        ...
        try:
            ...
            # Scale images to appropriate size for camera view
        ...
        if at_location:
            ...
            for anim in at_location:
                ...
                if anim.name in self.animatronic_images:
                    ...
                    # Fallback: draw circles if image not found
    ...
    def handle_mouse_click(self, pos: tuple):
        ...
        if self.state == GameState.MENU:
            ...
            # Click on camera selection buttons with proper positions
            cam_y = SCREEN_HEIGHT - 90
            cam_buttons = [
                (Location.STAGE, 120),
                (Location.DINING, 320),
            ...
            # Click to close camera - close hint at bottom
